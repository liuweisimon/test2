...
假设您要在 server_A 上安装“nats”。那么，相应的部署配置文件将包含以下作业。
此处我们还为我们要安装的 nats 作业指定了属性
...
现在，如果您要在 server_B 上安装“dea”。那么，用于 server_B 的部署配置文件将类似于下面的内容。
这种情况下“已安装”的作业 nats 及其属性是 router 所需要的。
